...
namespace PasswordAfterMailConfirmation.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            {
                TempData["error"] = "Old password and New password cannot be same";
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var callbackUrl = Url.Action("ConfirmEmail", "Account", new { userId = user.Id, code = code, Pass = model.Password }, protocol: Request.Url.Scheme);
                    await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
                    TempData["success"] = "Thank you for registering with us, We have sent a confirmation email to your registerd email Please confirm your email to get the password.";
                    return RedirectToAction("Index", "Home");
                }
                AddErrors(result);
            }
        ...
        [AllowAnonymous]
        public async Task<ActionResult> ConfirmEmail(int userId, string code, string Pass)
        {
            ...
            {
                TempData["error"] = "Email id is already confirmed, Please do login to access your account";
                return RedirectToAction("Index", "Home");
            }
            ...
            if (result.Succeeded)
            {
                ...
                //await UserManager.SendEmailAsync(userId, "Password", "Your Password is:" + Pass);
            }
        ...
        //    var Email = User.Identity.GetUserName();
        //    ApplicationUser user = await UserManager.FindByEmailAsync(Email);
        //    IdentityResult ComparePass = await UserManager.ChangePasswordAsync(user.Id, model.OldPassword, model.NewPassword);
        //    if (ComparePass.Succeeded)
        //    {
        ...
        //        }
        //    }
        //    TempData["error"] = "Your Old password is Incorrect or New password format is Incorrect";
        //    return RedirectToAction("ChangePassword");
        //}
        //
